                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="Street" id="Street" class="form-control" placeholder="Street/Building" value="{{$category->Street}}">	
                       <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="City" id="City" class="form-control" placeholder="City/State" value="{{$category->City}}">	
                        <p></p>
                        </div>
                    </div>	
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="Country" id="Country" class="form-control" placeholder="Country" value="{{$category->Country}}">	
                       <p></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="Contract" id="Contract" class="form-control" placeholder="Contract" value="{{$category->Contract}}">	
                       <p></p>
                        </div>
                    </div>
