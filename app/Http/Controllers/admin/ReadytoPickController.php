...
class ReadytoPickController extends Controller
{
    public function index(Request $request)
    {
        $parcels = Parcel::where('status', 'Ready to pickup')->paginate(10);
        ...
        return view('admin.parcel.readytolist', compact('parcels'));
    } 
}
